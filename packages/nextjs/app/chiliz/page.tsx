  ...
  return (
    <PageHomeNavigation
      ...
      subTitle="
        ...
        Now, using Talaria technology, the BCN team can distribute tokens to their users simply by sharing a code for future redemption with any wallet they choose.
