...
export interface TalariaProtocolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FIELD_SIZE"
      | "ROOT_HISTORY_SIZE"
...
export interface TalariaProtocol extends BaseContract {
  connect(runner?: ContractRunner | null): TalariaProtocol;
  waitForDeployment(): Promise<this>;

  interface: TalariaProtocolInterface;
