...
export interface CommitProtocolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FIELD_SIZE"
      | "ROOT_HISTORY_SIZE"
...
export interface CommitProtocol extends BaseContract {
  connect(runner?: ContractRunner | null): CommitProtocol;
  waitForDeployment(): Promise<this>;

  interface: CommitProtocolInterface;
