...
export interface AlephNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface AlephNFT extends BaseContract {
  connect(runner?: ContractRunner | null): AlephNFT;
  waitForDeployment(): Promise<this>;

  interface: AlephNFTInterface;
