...
export interface MatchTicketInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
...
export interface MatchTicket extends BaseContract {
  connect(runner?: ContractRunner | null): MatchTicket;
  waitForDeployment(): Promise<this>;

  interface: MatchTicketInterface;
