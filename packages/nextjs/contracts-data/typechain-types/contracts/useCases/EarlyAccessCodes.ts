...
export interface EarlyAccessCodesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FIELD_SIZE"
      | "ROOT_HISTORY_SIZE"
...
export interface EarlyAccessCodes extends BaseContract {
  connect(runner?: ContractRunner | null): EarlyAccessCodes;
  waitForDeployment(): Promise<this>;

  interface: EarlyAccessCodesInterface;
