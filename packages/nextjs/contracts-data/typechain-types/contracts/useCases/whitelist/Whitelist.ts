...
export interface WhitelistInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "addUserToWhitelist",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "bulkConsumeEarlyAccessCodes",
    values: [
      BytesLike[],
      BytesLike[],
      BytesLike[],
  ...
  encodeFunctionData(
    functionFragment: "bulkCreateEarlyAccessCodes",
  ...
  encodeFunctionData(
    functionFragment: "consumeEarlyAccessCode",
    values: [
      BytesLike,
      BytesLike,
      BytesLike,
  ...
  encodeFunctionData(
    functionFragment: "createEarlyAccessCode",
    values: [BytesLike, AddressLike[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "usersWhitelisted",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface Whitelist extends BaseContract {
  ...
  addUserToWhitelist: TypedContractMethod<
    [_user: AddressLike],
    [void],
    "nonpayable"
  >;

  bulkConsumeEarlyAccessCodes: TypedContractMethod<
    [
      ...
      _usersToWhitelist: AddressLike[]
    ],
    [void],
    "nonpayable"
  >;

  bulkCreateEarlyAccessCodes: TypedContractMethod<
    [_commitments: BytesLike[], _validationModules: AddressLike[][]],
    [void],
    "payable"
  >;
  ...
  consumeEarlyAccessCode: TypedContractMethod<
    [
      _commitment: BytesLike,
      _proof: BytesLike,
      _root: BytesLike,
      ...
      _to: AddressLike,
      _validationsArgs: BytesLike[],
      userToWhitelist: AddressLike
    ],
    [void],
    "nonpayable"
  >;

  createEarlyAccessCode: TypedContractMethod<
  ...
  removeUserFromWhitelist: TypedContractMethod<
    [_user: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  usersWhitelisted: TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
  ...
  getFunction(
    nameOrSignature: "addUserToWhitelist"
  ): TypedContractMethod<[_user: AddressLike], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "bulkConsumeEarlyAccessCodes"
  ): TypedContractMethod<
    [
      _commitments: BytesLike[],
      _proofs: BytesLike[],
  ...
  >;
  getFunction(
    nameOrSignature: "bulkCreateEarlyAccessCodes"
  ): TypedContractMethod<
    [_commitments: BytesLike[], _validationModules: AddressLike[][]],
    [void],
    "payable"
  ...
  >;
  getFunction(
    nameOrSignature: "consumeEarlyAccessCode"
  ): TypedContractMethod<
    [
      _commitment: BytesLike,
      _proof: BytesLike,
  ...
  >;
  getFunction(
    nameOrSignature: "createEarlyAccessCode"
  ): TypedContractMethod<
    [_commitment: BytesLike, _validationModules: AddressLike[]],
    [void],
    "payable"
  ...
  getFunction(
    nameOrSignature: "removeUserFromWhitelist"
  ): TypedContractMethod<[_user: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "usersWhitelisted"
