...
export interface MORFIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface MORFI extends BaseContract {
  connect(runner?: ContractRunner | null): MORFI;
  waitForDeployment(): Promise<this>;

  interface: MORFIInterface;
