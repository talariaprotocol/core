...
export interface AlephNFTAirdropperInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FIELD_SIZE"
      | "ROOT_HISTORY_SIZE"
      | "TransferId"
      | "ZERO_VALUE"
      | "bulkConsumeAlephNFTAirdrop"
      | "bulkCreateAlephNFTAirdrop"
      | "commitments"
      | "consumeAlephNFTAirdrop"
      | "consumeCode"
      | "consumeTransfer"
      | "consumed"
      | "createAlephNFTAirdrop"
      | "createTransfer"
      | "currentRootIndex"
      | "filledSubtrees"
      | "getLastRoot"
  ...
  encodeFunctionData(
    functionFragment: "bulkConsumeAlephNFTAirdrop",
    values: [
      BytesLike[],
      BytesLike[],
      BytesLike[],
  ...
  encodeFunctionData(
    functionFragment: "bulkCreateAlephNFTAirdrop",
  ...
  encodeFunctionData(
    functionFragment: "consumeAlephNFTAirdrop",
    values: [
      BytesLike,
      BytesLike,
      BytesLike,
  ...
  encodeFunctionData(
    functionFragment: "createAlephNFTAirdrop",
    values: [BytesLike, AddressLike[], BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface AlephNFTAirdropper extends BaseContract {
  connect(runner?: ContractRunner | null): AlephNFTAirdropper;
  waitForDeployment(): Promise<this>;

  interface: AlephNFTAirdropperInterface;
  ...
  bulkConsumeAlephNFTAirdrop: TypedContractMethod<
    [
  ...
  bulkCreateAlephNFTAirdrop: TypedContractMethod<
    [
      _commitments: BytesLike[],
  ...
  consumeAlephNFTAirdrop: TypedContractMethod<
    [
  ...
  createAlephNFTAirdrop: TypedContractMethod<
    [
      _commitment: BytesLike,
      _validationModules: AddressLike[],
      _id: BigNumberish,
  ...
  getFunction(
    nameOrSignature: "bulkConsumeAlephNFTAirdrop"
  ): TypedContractMethod<
    [
      _commitments: BytesLike[],
      _proofs: BytesLike[],
  ...
  >;
  getFunction(
    nameOrSignature: "bulkCreateAlephNFTAirdrop"
  ): TypedContractMethod<
    [
      _commitments: BytesLike[],
      _validationModules: AddressLike[][],
  ...
  getFunction(
    nameOrSignature: "consumeAlephNFTAirdrop"
  ): TypedContractMethod<
    [
      _commitment: BytesLike,
      _proof: BytesLike,
  ...
  getFunction(
    nameOrSignature: "createAlephNFTAirdrop"
  ): TypedContractMethod<
    [
      _commitment: BytesLike,
      _validationModules: AddressLike[],
