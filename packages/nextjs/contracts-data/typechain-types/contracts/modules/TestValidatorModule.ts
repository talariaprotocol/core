...
export interface TestValidatorModuleInterface extends Interface {
...
export interface TestValidatorModule extends BaseContract {
  connect(runner?: ContractRunner | null): TestValidatorModule;
  waitForDeployment(): Promise<this>;

  interface: TestValidatorModuleInterface;
