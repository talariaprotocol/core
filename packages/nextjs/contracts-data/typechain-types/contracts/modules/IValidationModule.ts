...
export interface IValidationModuleInterface extends Interface {
...
export interface IValidationModule extends BaseContract {
  connect(runner?: ContractRunner | null): IValidationModule;
  waitForDeployment(): Promise<this>;

  interface: IValidationModuleInterface;
