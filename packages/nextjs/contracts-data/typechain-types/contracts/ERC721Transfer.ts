...
export interface ERC721TransferInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FIELD_SIZE"
      | "ROOT_HISTORY_SIZE"
...
export interface ERC721Transfer extends BaseContract {
  connect(runner?: ContractRunner | null): ERC721Transfer;
