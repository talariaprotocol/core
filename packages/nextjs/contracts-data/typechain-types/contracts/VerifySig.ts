...
export interface VerifySigInterface extends Interface {
  getFunction(
...
export interface VerifySig extends BaseContract {
  connect(runner?: ContractRunner | null): VerifySig;
  waitForDeployment(): Promise<this>;

  interface: VerifySigInterface;
